...
from .models import EventType, Country, City, EventCategory, EventSubCategory, AppearanceType, Person, Organization, \
    ...
    InvestorStage, Gender, PersonType, OrganizationSubCategory, OrganizationRelation, LibraryContentType, \
    LibraryContent, PlatformBusinessSubModelType
...
admin.site.register(PlatformBusinessSubModelType)
...
admin.site.register(LibraryContent)
