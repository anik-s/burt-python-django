...
from org.views.helper import get_date
...
class Event(models.Model):
    ...
    slug = AutoSlugField(max_length=200, populate_from='name', null=True, unique=True)
...
class Person(models.Model):
    ...
    slug = AutoSlugField(max_length=200, populate_from='first_name', null=True, unique=True)
...
class PlatformBusinessSubModelType(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    name = models.CharField(max_length=100)
    platform_business_model_type = models.ForeignKey(PlatformBusinessModelType, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class OrganizationHasBusinessModelType(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE)
    pbm_type = models.ForeignKey(PlatformBusinessSubModelType, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Acquisition(models.Model):
    ...
    slug = AutoSlugField(max_length=200, populate_from='transaction_name', null=True, unique=True)
...
class News(models.Model):
    ...
    slug = AutoSlugField(max_length=200, populate_from='title', null=True, unique=True)
    ...
    thumbnail_url = models.TextField(validators=[URLValidator()], null=True)
...
class LibraryContent(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    title = models.TextField()
    slug = AutoSlugField(max_length=200, populate_from='title', unique=True)
    profile_image = models.ImageField(max_length=2056, upload_to='organization', default=None, null=True)
    ...
    content_type = models.ForeignKey(LibraryContentType, null=True, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class LibraryContentPerson(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    library_content = models.ForeignKey(LibraryContent, on_delete=models.CASCADE)
    person = models.ForeignKey(Person, on_delete=models.CASCADE)
...
class PersonLibraryContent(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    person = models.ForeignKey(Person, on_delete=models.CASCADE)
    library_content = models.ForeignKey(LibraryContent, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
class OrganizationLibraryContent(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE)
    library_content = models.ForeignKey(LibraryContent, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
class FundingLibraryContent(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    funding = models.ForeignKey(FundingRound, on_delete=models.CASCADE)
    library_content = models.ForeignKey(LibraryContent, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
class EventLibraryContent(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    event = models.ForeignKey(Event, on_delete=models.CASCADE)
    library_content = models.ForeignKey(LibraryContent, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
class PlatformLibraryContent(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    platform = models.ForeignKey(Platform, on_delete=models.CASCADE)
    library_content = models.ForeignKey(LibraryContent, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
class AcquisitionLibraryContent(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    acquisition = models.ForeignKey(Acquisition, on_delete=models.CASCADE)
    library_content = models.ForeignKey(LibraryContent, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
@receiver(post_save, sender=PersonJob)
def my_handler(sender, **kwargs):
    print('post save callback')


@receiver(pre_save, sender=LibraryContent)
def library_content_post_save_handler(sender, instance, **kwargs):
    instance.date = get_date(instance.date_year, instance.date_month, instance.date_day)


@receiver(pre_save, sender=PersonJob)
def library_content_post_save_handler(sender, instance, **kwargs):
    instance.start_date = get_date(instance.start_date_year, instance.start_date_month, instance.start_date_day)
    instance.end_date = get_date(instance.end_date_year, instance.end_date_month, instance.end_date_day)
