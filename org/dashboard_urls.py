...
from .views.library_content import LibraryCreateView, LibraryUpdateView, LibraryListView, LibraryListJson, \
    LibraryDeleteView
...
urlpatterns = [
    ...
    # library
    path('library/<pk>/update', LibraryUpdateView.as_view(), name='library_update'),
    path('library/<pk>/delete', LibraryDeleteView.as_view(), name='library_delete'),
