...
from org.forms.common import year_choices, month_choices, day_choices, delete_choices, \
    OrganizationSelect2MultipleWidget, OrganizationSelect2Widget
...
class PersonJobForm(forms.Form):
    ...
    def save(self, person):
        ...
        if deleted == '0':
            person_job = PersonJob(person=person, position=position, title=title, organization=organization, start_date_year=start_date_year,
