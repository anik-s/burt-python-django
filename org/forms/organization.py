...
from org.forms.platform import get_org_category_choices, get_org_pbm_type_choices
...
class OrganizationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['pbm_types'].choices = get_org_pbm_type_choices()
    ...
    pbm_types = forms.MultipleChoiceField(choices=(), required=False)
